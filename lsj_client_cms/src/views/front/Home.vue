    ...
    <div class="bg">
      <div style="width: 750px">
        <div style="display: flex">
          <el-input v-model="name" size="large" prefix-icon="el-icon-search" placeholder="请输入物品名称"></el-input>
          <el-button @click="$router.push({ path: '/front/search', query: { name: name } })" size="medium" type="primary" style="margin-left: 5px; background-color: #464646"><i class="el-icon-search"></i></el-button>
        </div>
      </div>
    </div>
